...
import com.eomcs.pp0723.domain.Board;
...
public class BoardHandler {
  ...
  // 내부에서만 사용하는 메소드는 프라이빗으로 막는다
  // 코드를 작성할때 프라이빗으로 무조건 작성후
  // 공개할 메소드만 public으로 바꾼다

  // 글로벌스탠다드 기준에 맞게 메소드명 작성 : findbyNo
