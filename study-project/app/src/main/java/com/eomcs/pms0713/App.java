...
public class App {
  ...
  static int promptInt (String command) {
    System.out.print(command);
    return Integer.parseInt(promptString(command)); 
  }

  static Date promptDate (String command) {
    System.out.print(command);
    return Date.valueOf(promptString(command)); 
  }
