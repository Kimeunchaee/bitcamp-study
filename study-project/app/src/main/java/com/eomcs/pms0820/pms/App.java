package com.eomcs.pms0820.pms;

import com.eomcs.pms0820.menu.Menu;
import com.eomcs.pms0820.menu.MenuGroup;
import com.eomcs.pms0820.pms.domain.Board;
import com.eomcs.pms0820.pms.domain.Member;
import com.eomcs.pms0820.pms.domain.Project;
import com.eomcs.pms0820.pms.domain.Task;
import com.eomcs.pms0820.pms.handler.BoardHandler;
import com.eomcs.pms0820.pms.handler.MemberHandler;
import com.eomcs.pms0820.pms.handler.ProjectHandler;
import com.eomcs.pms0820.pms.handler.TaskHandler;
import com.eomcs.pms0820.util.ArrayList;
import com.eomcs.pms0820.util.LinkedList;
...
public class App {
  ...
  // 제네릭 사용후 타입이름을 결정하지 않으면 Object로 결정됨 (E = object)
  // List<> boardList = new ArrayList<>();

  // 직접 타입이름 결정
  List<Board> boardList = new ArrayList<>();       //인스턴스를 생성할때 객체타입이 <Board>로 정해진다!
