...
public class ProjectHandler {
  ...
  // *멤버리스트의 exist를 사용하기위해 멤버리스트를 생성자로 받아와야한다
  ...
  public void list() {
    ...
    Project[] list = projectList.toArry();
  ...
  private String promptOwner(String label) {
    while (true) {
      ...
      // memberHandler 에서 호출했던걸 memberList 호출로 바꿔줌
      // 기존코드 if (this.memberHandler.exist(owner)) {
  ...
  private String promptMembers(String label) {
    ...
    while (true) {
      ...
      // 기존코드 if (this.memberHandler.exist(member)) {
